...
http://api.wunderground.com/api/e27870b4e5db6e4c/forecast/lang:FR/q/France/Paris.json
...
local city = "Paris"
local wuAPIkey = "e27870b4e5db6e4c" -- Your Weather Underground API Key

local eventTable = {
    ["l'anniversaire de jean-claude"] = "01/01/1900",
    ["l'anniversaire de marthe"] = "01/01/1900"
